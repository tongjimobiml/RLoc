...
def merge_2g_engpara():
    eng_para = pd.read_csv('2g/jiading_2g_gongcan.csv', encoding='gbk')
    eng_para = eng_para[['RNCID_1', 'CellID_1', 'BSID','Lon','Lat']]
...
data_2g=pd.read_csv("2g/jiading_2g_mode.csv")
...
print(np.median(error_tr), np.median(error_te))
